...
static void imprimirXMLSAT(void)
{
	//char dados[300];
       if(g_conectada == 1){
    	...
    	const char* dados = "path=C:\\Users\\oliveira_santana01\\Downloads\\TrabalhoAtualizado\\TrabalhoAtualizado\\XMLSAT.xml";
...
static void imprimirXMLCancelamentoSAT(void)
{
       ...
       if(g_conectada == 1){
    	...
    	const char* assQRCode = "path=C:\\Users\\oliveira_santana01\\Downloads\\TrabalhoAtualizado\\TrabalhoAtualizado\\CANC_SAT.xml";
